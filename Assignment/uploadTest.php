	...
	else
	{
		for($i=1;$i<=$qn;$i++)
		{
			echo 	'<hr/><table border="1" class="table"><tr><th colspan="2" class="rowH">No:'.$i.'</th></tr>
					...
					<tr><td class="column">Correct option</td><td><select name="'.$i.'CO"  id="input"><option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option></select></td></tr><table>
					<hr/>';
		}
		?>
		<table>

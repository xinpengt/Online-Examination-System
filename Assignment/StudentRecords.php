...
$GetStudentDetailsQuery="SELECT People.User_ID , People.F_Name , People.L_Name , Student.Prog_ID , People.DOB , People.Phone_Num , People.Email_Add From People INNER JOIN Student WHERE People.User_ID=Student.User_ID AND Student.User_ID='{$_REQUEST['UID']}'";
